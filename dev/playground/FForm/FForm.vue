<template>
    <section>
        ...
        <f-form center-form @submit="onFormSubmit" class="grid">
            <fieldset class="col-8">
                ...
                <div class="fform_fieldset_body">
                    ...
                    <div class="fform_row tea-center">
                        <f-option type="radio" checked v-model="values.radio1" label="yes" name="rad1" value="10" />
